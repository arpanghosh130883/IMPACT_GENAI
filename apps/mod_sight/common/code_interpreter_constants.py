from mod_sight.common.modSight_constants import COLUMN_DESC
...
Context:
The dataset contains a monthly summary of a client. The columns are described as: {COLUMN_DESC}. The data is aggregated by month, with MONTH_END_DATE representing the end of each month.
