...
from meeting_bot.common.summarise_constants import (
    MESSAGE_VAR,
...
st.set_page_config(page_title="Summarise", layout = "centered", page_icon=FAVICON_FILE_PATH)
...
with st.sidebar:
    ...
    if st.button(
        label="Upload a file",
        help="Upload meeting transcript or other supporting documents",
    ):
        upload_a_file()
...
disclimer_text = "Responses are generated by AI. Make sure to check for accuracy"
